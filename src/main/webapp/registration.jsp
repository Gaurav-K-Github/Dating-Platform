        ...
        <div class="auth-card">
            <div class="auth-header">
                ...
                <div class="auth-toggle">
                    <a href="${pageContext.request.contextPath}/login" class="toggle-option" style="text-decoration: none;">Login</a>
                    <div class="toggle-dot"></div>
                    <span class="toggle-option active">Create Account</span>
                </div>
            </div>
